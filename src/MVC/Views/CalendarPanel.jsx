...
/** Month calendar grid: header, day cells (colored by booking/past-date status/selection), and a legend. */
...
          const past = c.isPastDate(key);
          const disabledDay = full || past;
...
                        }}
                      >
                        {entry.fullName} ({getCameraShortName(c.cameras, c.camera)})
                      </span>
                    );
                  })}
                </span>
